...
class RAGTool(Tool):
    ...
    def __init__(
        self,
        knowledge_base_path: str = "./knowledge_base",  # 知识库目录
        qdrant_url: str = None,
        qdrant_api_key: str = None,
        collection_name: str = "rag_knowledge_base",    # 集合
        rag_namespace: str = "default"      # 命名空间
    ):
        super().__init__(
            name="rag",
        ...
        # RAG管道         Dict[rag_namespace, Dict[str, Any]]
